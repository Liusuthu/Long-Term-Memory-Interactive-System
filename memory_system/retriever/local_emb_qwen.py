...
def get_gte_model():
    # Only if we use local embed, we need to load the model
...
def get_qwen_embedding(query_batch, tokenizer, model, max_length=max_length):
